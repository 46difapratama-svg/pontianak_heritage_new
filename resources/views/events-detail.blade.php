...
<head>
    ...
    <title>{{ $item->nama_event }} - Pontianak Heritage</title>
...
<body class="bg-gray-50 text-gray-800">
    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            <!-- Tombol Kembali -->
            <a href="/festival-budaya" class="text-blue-600 hover:text-blue-800 font-semibold flex items-center gap-2 transition">
                <span>←</span>
                <span>Kembali ke Event & Festival</span>
            </a>
            
            <nav class="flex items-center gap-6">
                <a href="/" class="text-gray-600 hover:text-blue-600 font-medium transition duration-200">Home</a>
                <a href="/galeri-budaya" class="text-gray-600 hover:text-blue-600 font-medium transition duration-200">Galeri Budaya</a>
                <a href="/festival-budaya" class="text-blue-600 font-semibold transition duration-200">Event & Festival</a>
            </nav>
        </div>
    </header>
    ...
    <main class="max-w-4xl mx-auto px-6 py-12">
        <article class="bg-white rounded-3xl shadow-sm border border-gray-200 overflow-hidden p-8 md:p-12">
            ...
            <!-- Deskripsi Lengkap (Dilengkapi break-words agar teks panjang turun ke bawah) -->
